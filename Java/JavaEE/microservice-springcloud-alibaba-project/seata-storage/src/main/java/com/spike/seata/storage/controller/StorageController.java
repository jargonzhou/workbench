...
package com.spike.seata.storage.controller;

import com.spike.seata.storage.dao.entity.StorageExample;
import com.spike.seata.storage.dao.mapper.autogen.StorageMapper;
...
public class StorageController {
    ...
    public String echo(@PathVariable String commodityCode, @PathVariable int count) {
        ...
        LOGGER.info("Storage Service End ... commodityCode={},count={}, result={}", commodityCode, count, result);
        if (result == 1) {
            return SUCCESS;
        }
        return FAIL;
